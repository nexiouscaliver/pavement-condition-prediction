...
# from usemodels import generate_prediction_json
...
##usemodels.py static update to be faster
...
app =Flask(__name__)
CORS(app)
app.secret_key =  "anndeepamaam_792739"
app.config['SECRET_KEY'] = "anndeepamaam_792739"


@app.route('/')
def index():
    # return render_template('index.html')
    return jsonify('This is an API Gateway. Use correct endpoints.'),400

#example jason data
# {
#     "Rutting": null,
#     "Fatigue_Cracking": null,
#     "Block_Cracking": null,
#     "Longitudinal_Cracking": null,
#     "Transverse_Cracking": null,
#     "Patching": null,
#     "Potholes": null,
#     "Delamination": null,
...
def predict():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            fatigue_cracking = data['Fatigue_Cracking']
            block_cracking = data['Block_Cracking']
            longitudinal_cracking = data['Longitudinal_Cracking']
            transverse_cracking = data['Transverse_Cracking']
            patching = data['Patching']
            potholes = data['Potholes']
            delamination = data['Delamination']
            ...
            inputlist = [rutting,fatigue_cracking,block_cracking,longitudinal_cracking,transverse_cracking,patching,potholes,delamination,severity_rating,traffic_volume,temperature_c,precipitation_mm,maintenance_history]
            print(inputlist)
            result = generate_prediction_json(inputlist)
            return jsonify(result),200
        except Exception as e:
            print(e)
            return jsonify('Error in data'),400

if __name__ == '__main__':
    app.run(port=3388,debug=True)

#ngrok http --url=devoted-peacock-intensely.ngrok-free.app 3388